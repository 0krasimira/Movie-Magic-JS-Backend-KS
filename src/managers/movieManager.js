...
const movies = [
    {
        ...
        imageUrl: "https://upload.wikimedia.org/wikipedia/en/6/68/The_mummy.jpg",
...

    {
        ...
        imageUrl: "https://upload.wikimedia.org/wikipedia/en/3/32/Blue_lagoon_1980_movie_poster.jpg",
...

    {
        ...
        imageUrl: "https://i.scdn.co/image/ab67616d0000b273801f1a7ab9431179fe8ab39b",
...
exports.createMovies = (movieData) => {
 ...
 exports.getOne = (movieId) => {let neededMovie = movies.find(x => x.id === movieId)
    return neededMovie
}
